...
train, val, test = tt.data.TabularDataset.splits(
        path='../data/',
        format='csv',
        train="greek_corpus_train_charngram.csv",
        validation="greek_corpus_valid_charngram.csv", 
        test="greek_corpus_test_charngram.csv",
...
classifier.train_all(train_iter, val_iter, epochs=5, learning_rate=0.001)

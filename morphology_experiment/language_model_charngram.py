...
train, test, val = GreekCorpus.splits(TEXT, train="greek_corpus_train_charngram.txt", test="greek_corpus_test_charngram.txt", valid="greek_corpus_valid_charngram.txt")

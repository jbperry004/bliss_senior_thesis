...
train, test, val = GreekCorpus.splits(TEXT, train="greek_corpus_train_lemma_concat.txt", test="greek_corpus_test_lemma_concat.txt", valid="greek_corpus_valid_lemma_concat.txt")

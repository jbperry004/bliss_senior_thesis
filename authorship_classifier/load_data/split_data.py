...
def split_data():
    ...
    sentences_train.to_csv('sents_train.csv', index=False, sep='\t', header=False)
    sentences_valid.to_csv('sents_val.csv', index=False, sep='\t', header=False)
    sentences_test.to_csv('sents_test.csv', index=False, sep='\t', header=False)
    ...
    groups_train.to_csv('groups_train.csv', index=False, sep='\t', header=False)
    groups_valid.to_csv('groups_val.csv', index=False, sep='\t', header=False)
    groups_test.to_csv('groups_test.csv', index=False, sep='\t', header=False)